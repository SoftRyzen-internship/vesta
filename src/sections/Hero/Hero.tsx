...
export const Hero: React.FC = () => {
  ...
  return (
    <section
      className={`${css.heroBg} h-[640px] md:h-[1024px] xl:h-[800px] pt-[25px] pb-8 md:pt-10 md:pb-[67px] m-auto xl:pb-[65px] xl:bg-[length:1440px_800px] bg-color-bg`}
    >
      <div className="container flex flex-col h-full">
        ...
        <p className="text-color-text-primary text-sm font-light opacity-80 w-80 md:text-base md:w-[592px] xl:text-lg mt-auto">
          ...
          <a
            ...
            href={`mailto:${mail}`}
            className="underline underline-offset-2 transition-all hover:no-underline hover:underline-offset-4"
          >
            {mail}
          </a>
        </p>
